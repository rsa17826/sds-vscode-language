  ...
  vscode.languages.registerDocumentRangeFormattingEditProvider(
    "sds",
    {
      provideDocumentRangeFormattingEdits: (document) => {
        ...
        var loadedData = loadData(text, true)
        if (!loadedData) {
          return []
        }
        const formattedText = saveData(loadedData) // Process the text
        if (!formattedText) {
          return []
        }
        return [vscode.TextEdit.replace(fullRange, formattedText)] // Return the edit
      },
    }
  )
}
...
declare var debug: (...args: any[]) => void
declare var error: (...args: any[]) => void
declare var info: (...args: any[]) => void
declare var log: (...args: any[]) => void
declare var warn: (...args: any[]) => void
declare var dir: (...args: any[]) => void
declare var dirxml: (...args: any[]) => void
declare var table: (...args: any[]) => void
declare var trace: (...args: any[]) => void
declare var group: (...args: any[]) => void
declare var groupCollapsed: (...args: any[]) => void
declare var groupEnd: (...args: any[]) => void
declare var clear: (...args: any[]) => void
declare var count: (...args: any[]) => void
declare var countReset: (...args: any[]) => void
declare var assert: (...args: any[]) => void
declare var profile: (...args: any[]) => void
declare var profileEnd: (...args: any[]) => void
declare var time: (...args: any[]) => void
declare var timeLog: (...args: any[]) => void
declare var timeEnd: (...args: any[]) => void
declare var timeStamp: (...args: any[]) => void
declare var context: (...args: any[]) => void
declare var createTask: (...args: any[]) => void
declare var memory: (...args: any[]) => void

function gettype(thing: any, match: any = undefined) {
  if (
    !match ||
    ...
    match = [...new Set(match)]
    return !!match.indexOf((e: any) => gettype(thing, e))
  }
}
...
function loadData(d: string, exact?: boolean): any {
  ...
  class objKeyObj {
    ...
    // constructor(obj: object | undefined = undefined) {
    //   this.keys = []
    //   this.values = []
  ...
  class int {
    #i: number
    constructor(i: number | int | float) {
      this.#i = Number(i)
    }
    toString() {
      return `${this.#i}`
  ...
  function __int(num: any) {
    return exact ? new int(num) : Number(num)
  }
  function __float(num: any) {
  ...
  while (1) {
    ...
    if (remainingData[0] == "]" || remainingData[0] == "}") {
      ...
      var dataToInsert: any = _stack.pop()
      var thingToPutDataIn: any = _stack.pop()
      ...
      if (_stack.length) {
        ...
        if (lastItem == null) {
          ...
          if (gettype(lastItem, "object")) {
            ...
            if (!innerDataFound) {
              if (!removeDuplicateKeys && lastItem.has(thisdata)) {
                return undefined
              }
...
function saveData(val: any, _level = 0): string {
  // print("saveData", val)
